...
class EyeDat:
    ...
    def __init__(self, health, exp, trial):
        ...
        df_s = [(pd.read_csv(n[0], delim_whitespace=1, decimal=',',
                             usecols=["CURRENT_FIX_START", "CURRENT_FIX_END", "CURRENT_FIX_X", "CURRENT_FIX_Y",
                                      "CURRENT_FIX_DURATION"]),
                 pd.read_csv(n[1], delimiter='\t', decimal=',',
                             usecols=["LEFT_GAZE_X", "LEFT_GAZE_Y", "RIGHT_GAZE_X", "RIGHT_GAZE_Y"])) for n in fnames]
